    ...
    <div class="container">
        ...
        <div class="row">
            <main class="col-sm-9">
                           ...
                           <a href="index.php/SingleController/getData/<?php echo $post->id;?>"><i class="fa fa-fa-comments-o" aria-hidden="true"></i><span> <?php echo $post->Rate;?></span>
                            <i class="fa fa-reddit-alien" aria-hidden="true"></i><span></span></div>
                            <div class="col-xs-4">
